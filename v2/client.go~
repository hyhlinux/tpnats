...
func (c *client) processConnect(arg []byte) error {
	...
	srv := c.srv
	c.mu.Unlock()
	fmt.Println("S C c.opts.devId:", c.opts.DevId)
...
func (c *client) clearConnection() {
	fmt.Println("S C closeConnection...start", c.cid)
	if c.nc == nil {
		return
	}
	c.bw.Flush()
	c.nc.Close()
	fmt.Println("S C closeConnection...end", c.cid)
}
...
func (c *client) closeConnection() {
	...
	fmt.Println("S C closeConnection...end")
	c.mu.Unlock()
